            ...
            <div className="mt-5 animate-fade-in rounded border border-emerald-200 bg-emerald-50 p-3 dark:border-emerald-500/30 dark:bg-emerald-500/10">
              ...
              <div className="flex items-center gap-2">
                <input
                  readOnly
                  value={link}
                  className="w-full min-w-0 rounded border border-emerald-200 bg-white px-2 py-1.5 text-xs text-slate-800 dark:border-emerald-500/30 dark:bg-slate-800 dark:text-slate-100"
                />
                <button
                  onClick={copyLink}
