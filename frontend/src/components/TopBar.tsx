...
export function TopBar({ email, onLogout }: { email?: string; onLogout: () => void }) {
  return (
    <header className="flex h-14 shrink-0 items-center justify-end gap-3 border-b border-slate-200 bg-white px-4 transition-colors duration-200 dark:border-slate-700 dark:bg-slate-800">
